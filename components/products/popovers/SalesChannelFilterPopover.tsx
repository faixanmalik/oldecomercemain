...
export default function SalesChannelFilterPopover({ salesChannels, selectedSalesChannel, onChange }: { salesChannels: SalesChannel[], selectedSalesChannel: SalesChannel | null, onChange: (salesChannelId: string | null) => void | Promise<void> }) {
    ...
    <Popover>
      ...
      <PopoverContent className="w-max whitespace-nowrap p-3 rounded-xl">
        <div className="flex flex-col gap-2 w-full items-start">
          ...
          <RadioGroup defaultValue={selectedSalesChannel?._id} onValueChange={onChange} className="mt-4 flex flex-col gap-2">
            {
          ...
          <TextButton className="mt-2" disabled={selectedSalesChannel === null} onClick={() => onChange(null)}>
            Clear
          </TextButton>
