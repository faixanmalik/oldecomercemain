        ...
        >
          <input
            ...
            className="before:content[''] peer relative h-4 w-4
              cursor-pointer appearance-none rounded border
              border-neutral-500 transition-all before:absolute 
              ...
              checked:bg-gray-900 checked:before:bg-gray-900 hover:border-black"
            id={id}
          />
          <span
            className="absolute text-white
          transition-opacity opacity-0 pointer-events-none 
          top-2/4 left-2/4 -translate-y-2/4 
